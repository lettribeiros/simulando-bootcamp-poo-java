<h1>Abstraindo e Implementando Métodos Simulando a Lógica de Um Bootcamp</h1>
...
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs também foram MODELADAS, ou seja, criei seus ATRIBUTOS E MÉTODOS <br> 
<strong>	4.</strong> Para que o código fique mais legível e de fácil manutenção, utilizei de algumas das ferramentas que o PARADIGMA DE ORIENTAÇÃO A OBJETOS (POO) nos oferece: ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO <br>
<strong>	5.</strong> E para representar CLASSES que foram criadas e relacionadas, transformei-as em OBJETOS<br>
</p>
